  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside:
          'day-outside text-muted-foreground opacity-50 aria-selected:bg-primary-lightest/50 aria-selected:text-muted-foreground aria-selected:opacity-30 rounded-md',
